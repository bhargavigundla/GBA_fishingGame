...
void drawStartString() {
    drawString(calculateCenter(19), 70, "press START to play", ((31) | (31)<<5 | (31)<<10));
}
...
void drawWinString() {
    drawString(calculateCenter(8), 70, "you win!", ((31) | (31)<<5 | (31)<<10));
    printScore();
}

void drawLoseString() {
    drawString(calculateCenter(9), 60, "game over", ((31) | (31)<<5 | (31)<<10));
    drawString(calculateCenter(29), 70, "press start to return to menu", ((31) | (31)<<5 | (31)<<10));
    printScore();
}
...
void printScore() {
    ...
    drawStringWithBackground(calculateCenter(9), 3, scoreStr, 0x7292, 0x7FDB);
}
